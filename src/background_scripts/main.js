...
class BingEngine extends SearchEngine {
  ...
  findOrganicTitleUrl(domElement) {
    console.log(domElement.firstChild.firstChild.firstChild);
    ...
    if (domElement.firstChild.firstChild.tagName == 'H2') {
      ...
      if (domElement.firstChild.firstChild.firstChild.tagName == "DIV"){
        return domElement.firstChild.firstChild.firstChild.firstChild.firstChild;
      }
    }
