class SearchEngine {
    ...
    retrieveSearch(data) {
        ...
        var organicResults = responseDoc.getElementsByClassName(this.organicResultClass);
    ...
    addIcons(data, searchEngine1, searchEngine2) {
        ...
        extension.getCurrentTab().then((tabs) => {
            browser.tabs.sendMessage(tabs[0].id, {
                call: "addIcons",
                args: [results1, results2, searchEngine1.img, searchEngine2.img, this.organicResultClass]
            });
        });
    }
}
...
class DuckDuckGoEngine extends SearchEngine {
    ...
    img = "https://img.utdstc.com/icons/duckduckgo-search-and-stories-android.png:l"
